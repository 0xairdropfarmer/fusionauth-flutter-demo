...
const String AUTH0_DOMAIN = '4f81b693d630.ngrok.io';
const String AUTH0_CLIENT_ID = '7d2b4cb4-ccd5-42ac-8469-f802393c8f98';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<Map<String, Object>> getUserDetails(String accessToken) async {
    const String url = 'https://$AUTH0_DOMAIN/oauth2/userinfo';
